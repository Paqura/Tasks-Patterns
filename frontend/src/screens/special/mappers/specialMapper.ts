...
import { mapImageMediaFile, mapVideoMediaFile } from '@/shared/lib/mappers/strapi'
...
export const toDomain = (serverData: GetAttributesValues<'api::sp.sp'>): TSpecialPageData => {
