...
const mapAdvantage = (data?: GetAttributesValues<'main.advantage-card'>): TAdvantageCard => ({
    title: data?.title || '',
...
export const mapAdvantagesBlockServerData = (block: TBackendBlockData): TAdvantagesBlockData => {
    return {
        ...
        expertiseCard: mapAdvantage(block.expertiseCard),
        customerServiceCard: mapAdvantage(block.customerServiceCard),
        trackRecordCard: mapAdvantage(block.trackRecordCard),
        technologyCard: mapAdvantage(block.technologyCard),
        solutionsCard: mapAdvantage(block.solutionsCard),
    }
}
